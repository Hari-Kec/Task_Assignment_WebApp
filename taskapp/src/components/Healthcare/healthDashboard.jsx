...
const HealthCharts = () => {
  ...
  const barOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Task Completion by Doctors',
      },
    },
    scales: {
      x: {
  ...
  // Radar Chart Data
  const radarData = {
    labels: ['Patient Assessment', 'Diagnosis', 'Treatment Planning', 'Surgery', 'Prescription', 'Follow-up Care', 'Consultation', 'Medical Research'],
