...
const FireService = () => {
  ...
  const moveTask = (task, source, target, newStatus) => {
    ...
    axios.put(`http://3.26.234.195:5000/fireservice/${task._id}`, { ...task, status: newStatus })
  ...
  const handleFormSubmit = (e) => {
    ...
    axios.post('http://3.26.234.195:5000/fireservice', task)
      .then((response) => {
  ...
  const deleteTask = (taskId, status) => {
    axios.delete(`http://3.26.234.195:5000/fireserviceTasks/${taskId}`)
      .then(() => {
